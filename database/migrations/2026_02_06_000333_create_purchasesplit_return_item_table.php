...
return new class extends Migration
{
    ...
    {
        Schema::create('purchasesplit_return_item', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('purchasesplit_return_id');
            ...
            $table->integer('purchase_split_return_id');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('purchasesplit_return_item');
    }
};
