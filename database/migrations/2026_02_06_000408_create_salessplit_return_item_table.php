...
return new class extends Migration
{
    ...
    {
        Schema::create('salessplit_return_item', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('salessplit_return_id');
            ...
            $table->integer('sales_split_return_id');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('salessplit_return_item');
    }
};
