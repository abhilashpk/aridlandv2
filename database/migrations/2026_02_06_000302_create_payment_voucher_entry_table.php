...
return new class extends Migration
{
    ...
    {
        Schema::create('payment_voucher_entry', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->index(["payment_voucher_id", "account_id", "entry_type", "job_id", "department_id", "is_fc", "currency_id", "bank_id", "status", "deleted_at", "is_onaccount", "party_account_id"], 'payment_voucher_id');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('payment_voucher_entry');
    }
};
