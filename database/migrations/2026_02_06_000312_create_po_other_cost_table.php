...
return new class extends Migration
{
    ...
    {
        Schema::create('po_other_cost', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->index(["purchase_order_id", "dr_account_id", "cr_account_id", "status", "deleted_at"], 'purchase_order_id');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('po_other_cost');
    }
};
