...
return new class extends Migration
{
    ...
    {
        Schema::create('pdc_issued', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->index(["voucher_type", "voucher_id", "cr_account_id", "dr_account_id", "status", "deleted_at", "voucher_date", "supplier_id"], 'voucher_type');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('pdc_issued');
    }
};
