...
class QuotationSalesRepository extends AbstractValidator implements QuotationSalesInterface {
	...
	private function setInputValue($attributes)
	{
		...
		$this->quotation_sales->job_id 		 = isset($attributes['job_id'])?$attributes['job_id']:'';
		$this->quotation_sales->header_id 	 = isset($attributes['header_id'])?$attributes['header_id']:'';
		$this->quotation_sales->footer_id 	 = isset($attributes['footer_id'])?$attributes['footer_id']:'';
