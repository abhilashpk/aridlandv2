...
class SupplierDoRepository extends AbstractValidator implements SupplierDoInterface {
	...
	private function setInputValue($attributes)
	{
		...
		$this->supplier_do->document_id = isset($attributes['document_id'])?$attributes['document_id']:'';
		$this->supplier_do->job_id = isset($attributes['job_id'])?$attributes['job_id']:'';
		$this->supplier_do->description = isset($attributes['description'])?$attributes['description']:'';
		...
		$this->supplier_do->location_id = isset($attributes['location_id'])?$attributes['location_id']:'';
