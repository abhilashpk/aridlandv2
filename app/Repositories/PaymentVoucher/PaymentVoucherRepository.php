...
class PaymentVoucherRepository extends AbstractValidator implements PaymentVoucherInterface {
	...
	private function setInputValue($attributes)
	{
		...
		$this->payment_voucher->department_id  =env('DEPARTMENT_ID');
		//MR12
...
<<<<<<< HEAD
					$accset = DB::table('account_setting')->where('voucher_type_id',$attributes['voucher'])->where('status',1)->where('department_id', env('DEPARTMENT_ID'))->where('deleted_at','0000-00-00 00:00:00')->first();//echo '<pre>';print_r($accset);exit;
=======
