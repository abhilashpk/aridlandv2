...
class StockTransactionController extends Controller
{
	...
	public function getSearch(Request $request)
	{
		...
		if ($request->get('search_type') === 'detail') {
			...
			// pass all request data safely
			$results = $this->itemmaster->getStockTransactionReport($request->all());

			$titles = [
				'main_head' => 'Stock Transaction Report',
				'subhead'   => 'Stock Transaction Report'
			];
		}
	...
	public function dataExport(Request $request)
	{
		...
		// Get report data using request instead of Input
		$results = $this->itemmaster->getStockTransactionReport($request->all());
		...
		// Download using new Laravel Excel version
