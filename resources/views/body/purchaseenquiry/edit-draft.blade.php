                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="fa fa-fw fa-crosshairs"></i> Edit Purchase Enquiry
                            </h3>
                               ...
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<a href="{{ url('purchase_enquiry') }}" class="btn btn-danger">Cancel</a>
										<a href="{{ url('purchase_enquiry/edit/'.$orderrow->id) }}" class="btn btn-warning">Clear</a>
                                    </div>
                                </div>
...
function updateDraft() {
    ...
    document.frmPurchaseEnquiry.action="{{ url('purchase_enquiry/update_draft/'.$orderrow->id) }}";
     document.frmPurchaseEnquiry.submit();
}
