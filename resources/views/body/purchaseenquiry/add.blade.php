                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="fa fa-fw fa-crosshairs"></i> New Purchase Enquiry 
                            </h3>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
                               ...
                               <input type="hidden" id="selected_locfrom_id" name="locfrom_id" value="{{(old('locfrom_id'))?old('locfrom_id'):''}}">
								...
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label <?php if($errors->has('voucher_no')) echo 'form-error';?>">PE. No.</label>
                                    <div class="col-sm-10">
...
function submitDraft() {
    $('#is_draft').val(1);
    document.frmPurchaseEnquiry.action="{{ url('purchase_enquiry/save_draft') }}";
