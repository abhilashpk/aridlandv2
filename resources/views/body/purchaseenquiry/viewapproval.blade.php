                    ...
                    <div class="panel panel-<?php if($orderrow->approval_status==2) { echo 'danger'; } elseif($orderrow->approval_status==1) { echo 'warning'; } else echo 'primary';?>">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="fa fa-fw fa-crosshairs"></i> <?php if($orderrow->approval_status==2) { echo 'Rejected'; } elseif($orderrow->approval_status==1) { echo 'Approved'; } else echo 'Purchase Enquiry';?>
                            </h3>
                        ...
                        <div class="panel-body">
							<div class="controls"> 
                            <form class="form-horizontal" role="form" method="POST" name="frmPurchaseEnquiry" id="frmPurchaseEnquiry" action="{{ url('purchase_enquiry/update/'.$orderrow->id) }}">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
								<input type="hidden" name="purchase_enquiry_id" id="purchase_enquiry_id" value="{{ $orderrow->id }}">
							...
							@php $selectedLocId = $orderrow->locfrom_id; @endphp
                              ...
                              <font color="#16A085">   <label class="col-sm-2 control-label"><b>Location From</b><span class="text-danger">*</span></label></font>
                               ...
                               <input type="hidden" id="selected_locfrom_id" name="locfrom_id" value="{{ $selectedLocId }}">
								...
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">PE. No.</label>
                                    <div class="col-sm-10">
								...
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">PE. Date</label>
                                    <div class="col-sm-10">
                               ...
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <a href="{{ url('purchase_enquiry') }}" class="btn btn-warning">Cancel</a>
                                    </div>
                                </div>
...
$(document).ready(function () { 
    ...
    $('#frmPurchaseEnquiry').bootstrapValidator({
        ...
        $('#frmPurchaseEnquiry').data('bootstrapValidator').resetForm();
    });
...
function funApproval(id) {
	...
	if(con==true) {
		var url = "{{ url('purchase_enquiry/approve/') }}";
		location.href = url+'/'+id;
	}
}

function funReject(id) {
	var con = confirm('Are you sure you want to reject this ?');
	if(con==true) {
		var url = "{{ url('purchase_enquiry/reject/') }}";
		location.href = url+'/'+id;
	}
}
