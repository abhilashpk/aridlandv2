                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmPurchaseInvoice" id="frmPurchaseInvoice" action="{{ url('purchase_order/save') }}">
                               ...
                               <input type="hidden" id="selected_locfrom_id" name="location_id" value="{{ $selectedLocId }}">
								...
								<div class="form-group">
                                    <label for="input-text" class="col-sm-2 control-label">Purchase Enquiry No.</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="po_no" name="po_no" placeholder="Purchase Order No" value="{{$ponos}}" autocomplete="off">
                                    </div>
                                </div>
								<input type="hidden" id="document_id" name="document_id" value="{{$pordid}}">
								<input type="hidden" id="document_type" name="document_type" value="PE">
