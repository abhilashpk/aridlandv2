                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw fa-crosshairs"></i> New Sales Invoice Cash
                            </h3>
                        </div>
                            ...
                            <form class="form-horizontal" role="form" method="POST" name="frmSalesInvoice" id="frmSalesInvoice" action="{{ url('sales_invoice/save') }}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                       <select id="voucher_id" class="form-control select2" style="width:100%" name="voucher_id">
											...
											<option value="{{ $vouchers[1]['id'] }}" <?php if($voucherid==$vouchers[1]['id']) echo 'selected';?>>{{ $vouchers[1]['voucher_name'] }}</option>
							    ...
							    <div class="col-sm-10">
                                  <label class="radio-inline">
 								    <input type="radio" class="loccom-radio" name="is_company" value="" ><b>Comapny</b></font>
							       </label>
                               ...
                               <input type="hidden" id="selected_locfrom_id" name="location_id" value="{{ $selectedLocId }}">
								...
								<div class="form-group">
									...
									<input type="hidden" name="curno" id="curno" value="{{$vouchers[1]['voucher_no']}}">
                                    <div class="col-sm-10">
									<div class="input-group">
                                        <span class="input-group-addon" id="prefixBox">{{$vouchers[1]->prefix}}</span>
                                        <input type="text" class="form-control" id="voucher_no" readonly name="voucher_no" placeholder="{{$vouchers[1]['voucher_no']}}">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										...
										<input type="hidden" name="cr_account_id" id="cr_account_id" class="form-control" value="{{ $vouchers[1]['cr_account_master_id'] }}">
									</div>
                                </div>
